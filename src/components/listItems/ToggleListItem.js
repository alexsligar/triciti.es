...
import { handleAddListItem, handleRemoveListItem } from '../../actions/listItems/toggleListItem';

export class ToggleListItem extends Component {

    handleToggleListItem = () => {
        const { listId, itemId, listItemExists, handleAddListItem, handleRemoveListItem } = this.props;
        if(listItemExists) {
...
export default connect(null, mapDispatchToProps)(ToggleListItem);
