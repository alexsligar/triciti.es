...
import { handleUpdateList, removeUpdateListError } from '../../actions/lists/updateList';
...
export class ListForm extends Component {
    ...
    render() {
        const { addListProcessing, addListError, updateListProcessing, updateListError } = this.props;
...
const mapDispatchToProps = { handleAddList, removeAddListError, handleUpdateList, removeUpdateListError };
