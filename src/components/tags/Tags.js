...
import { Container, Grid, Icon, Header, Search, Label, Dimmer, Loader, Message } from 'semantic-ui-react';
    ...
    render() {
        if (this.props.loading) {
            ...
            return (
                <Container>
                    <Message negative>
                        <Message.Header>Sorry, there was an error loading the tags. Please try again.</Message.Header>
                    </Message>
                </Container>
            );
        }
